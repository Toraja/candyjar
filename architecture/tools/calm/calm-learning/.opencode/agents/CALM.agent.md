...
permission:
  edit:
    "*": ask
    "architecture/tools/calm/calm-learning/architectures/*.json": allow
  bash:
    "*": ask
    "calm validate *": allow
---
...
2. Read these tool prompt files to understand current CALM guidance:
    - `.opencode/agents/calm-prompts/architecture-creation.md`
    - `.opencode/agents/calm-prompts/calm-cli-instructions.md`
    - `.opencode/agents/calm-prompts/node-creation.md`
    - `.opencode/agents/calm-prompts/relationship-creation.md`
    - `.opencode/agents/calm-prompts/interface-creation.md`
    - `.opencode/agents/calm-prompts/metadata-creation.md`
    - `.opencode/agents/calm-prompts/control-creation.md`
    - `.opencode/agents/calm-prompts/flow-creation.md`
    - `.opencode/agents/calm-prompts/pattern-creation.md`
    - `.opencode/agents/calm-prompts/documentation-creation.md`
    - `.opencode/agents/calm-prompts/standards-creation.md`
    - `.opencode/agents/calm-prompts/moment-creation.md`
    - `.opencode/agents/calm-prompts/timeline-creation.md`
    - `.opencode/agents/calm-prompts/decorator-creation.md`
